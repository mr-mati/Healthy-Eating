...
import com.mati.tracker_data.remote.malformedFoodResponse
import com.mati.tracker_data.remote.validFoodResponse
...
class TrackerRepositoryImplTest {
    ...
    @Test
    fun `Search foods, valid response, return response`() = runBlocking {
